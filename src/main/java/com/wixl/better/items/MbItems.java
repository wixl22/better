...
//
//	public static final Item MINING_HELMET = register("mining_helmet", new MbArmorItem(MbArmorMaterials.MINING_HELMET, EquipmentSlot.HEAD, new Item.Settings().group(ItemGroup.COMBAT)));
//	public static final Item TORCH = register(new WallStandingBlockItem(MbBlocks.TORCH_BLOCK, MbBlocks.WALL_TORCH_BLOCK, (new Item.Settings()).group(ItemGroup.DECORATIONS)));
